...
\begin{minipage}[t]{0.4\textwidth} % 40% of the page width for the introduction text
	...
	Conscientious, dedicated, and hard-working explorer, looking for opportunities to learn, to network and to help others. Constantly pushing myself to grow as a software developer and as a person. Always searching for new ideas and experiences so that others can rely on me for help. \\ % Dummy text
\end{minipage}
...
\begin{center}
	\bubbless{6/Teamwork, 3/Data Analysis, 5/Adaptability, 4/SEO, 5/Customer Relations}
\end{center}
